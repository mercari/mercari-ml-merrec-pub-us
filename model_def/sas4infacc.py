# Derived from https://github.com/yuangh-x/2022-NIPS-Tenrec/blob/master/model/inference_acceleration/sas4infacc.py
...
class SAS4infaccModel(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.bert = BERT(args)
        self.out = nn.Linear(self.bert.hidden, args.num_products + 1)
        self.all_time = 0
