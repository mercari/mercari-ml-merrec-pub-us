# Taken from https://github.com/yuangh-x/2022-NIPS-Tenrec/blob/master/model/ctr/dcn.py
"""
Author:
...
class DCN(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, cross_num=2, cross_parameterization='vector',
                 dnn_hidden_units=(256, 256), l2_reg_linear=0.00001, l2_reg_embedding=0.00001, l2_reg_cross=0.00001,
